...
contract Land {
    ...
    function registerSeller(string memory _name, uint _age, string memory _idNo, string memory _kraPin, string memory _landsOwned, string memory _document) public {
        ...
        sellersCount++;
        SellerMapping[msg.sender] = Seller(msg.sender, _name, _age, _idNo,_kraPin, _landsOwned, _document);
        sellers.push(msg.sender);
        emit Registration(msg.sender);
    }

    function updateSeller(string memory _name, uint _age, string memory _idNo, string memory _kraPin, string memory _landsOwned) public {
        ...
        SellerMapping[msg.sender].kraPin = _kraPin;
    ...
    function getSellerDetails(address i) public view returns (string memory, uint, string memory, string memory, string memory, string memory) {
        return (SellerMapping[i].name, SellerMapping[i].age, SellerMapping[i].idNo, SellerMapping[i].kraPin, SellerMapping[i].landsOwned, SellerMapping[i].document);
    }

    function registerBuyer(string memory _name, uint _age, string memory _city, string memory _idNo, string memory _kraPin, string memory _document, string memory _email) public {
        ...
        buyersCount++;
        BuyerMapping[msg.sender] = Buyer(msg.sender, _name, _age, _city, _idNo, _kraPin, _document, _email);
        buyers.push(msg.sender);

        emit Registration(msg.sender);
    }

    function updateBuyer(string memory _name,uint _age, string memory _city,string memory _idNo, string memory _email, string memory _kraPin) public {
        ...
        BuyerMapping[msg.sender].kraPin = _kraPin;
    ...
    function getBuyerDetails(address i) public view returns ( string memory,string memory, string memory, string memory, string memory, uint, string memory) {
        return (BuyerMapping[i].name,BuyerMapping[i].city , BuyerMapping[i].kraPin, BuyerMapping[i].document, BuyerMapping[i].email, BuyerMapping[i].age, BuyerMapping[i].idNo);
    }
